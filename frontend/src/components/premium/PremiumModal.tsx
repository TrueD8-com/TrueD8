          ...
          {!selectedTier ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {PREMIUM_TIERS.map((tier) => {
                ...
                const isUpgrade =
                  currentTier &&
                  PREMIUM_TIERS.findIndex((t) => t.id === currentTier) <
                    PREMIUM_TIERS.findIndex((t) => t.id === tier.id);
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <CardHeader>
                        <div
                          className={`w-12 h-12 rounded-full bg-gradient-to-r ${tier.color} flex items-center justify-center mb-3`}
                        >
                          {tier.icon}
                        </div>
            ...
            <div className="space-y-4">
              ...
              <Card
                className={`border-white/20 bg-gradient-to-r ${selectedTier.color} bg-opacity-10 backdrop-blur-xl`}
              >
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-10 h-10 rounded-full bg-gradient-to-r ${selectedTier.color} flex items-center justify-center`}
                      >
                        {selectedTier.icon}
                      </div>
                      <div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setPaymentChainId(parseInt(value))
                      }
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      value={paymentToken}
                      onValueChange={(value) =>
                        setPaymentToken(value as SUPPORTED_TOKENS)
                      }
                      disabled={isExecuting || isSuccess}
                    >
                    ...
                    <p className="text-xs text-gray-400">
                      {selectedTier.price} {paymentToken} = $
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-xs text-purple-900 dark:text-purple-100">
                        ...
                        <p className="text-purple-700 dark:text-purple-300">
                          Your {paymentToken} will be bridged from{" "}
                          {
                            SUPPORTED_CHAINS.find(
                              (c) => c.id === paymentChainId
                            )?.name
                          }{" "}
                          to Base Sepolia and automatically processed - all in
                          one transaction!
                        </p>
                      </div>
                    </div>
                  ...
                  {isSuccess && (
                    <div className="space-y-3">
                      ...
                      <div
                        className={`rounded-lg bg-gradient-to-r ${selectedTier.color} bg-opacity-10 p-4 text-center`}
                      >
